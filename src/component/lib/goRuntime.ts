    ...
    constructor() {
        ...
        this.importObject = {
            wasi_snapshot_preview1: {
                ...
                fd_write: function(fd: any, iovs_ptr: any, iovs_len: any, nwritten_ptr: any) {
                    let nwritten = 0;
                    if (fd == 1) {
            ...
            gojs: {
                ...
                "syscall/js.valueSet": (v_ref: any, p_ptr: any, p_len: any, x_ref: any) => {
                ...
                "syscall/js.valueCall": (ret_addr: any, v_ref: any, m_ptr: any, m_len: any, args_ptr: any, args_len: any, args_cap: any) => {
                    const v = unboxValue(v_ref);
                ...
                "syscall/js.valueInvoke": (ret_addr: any, v_ref: any, args_ptr: any, args_len: any, args_cap: any) => {
                    try {
                        const v = unboxValue(v_ref);
                        const args = loadSliceOfValues(args_ptr, args_len, args_cap);
                ...
                "syscall/js.valueNew": (ret_addr: any, v_ref: any, args_ptr: any, args_len: any, args_cap: any) => {
                    const v = unboxValue(v_ref);
                    const args = loadSliceOfValues(args_ptr, args_len, args_cap);
                    try {
                ...
                "syscall/js.valueLoadString": (v_ref: any, slice_ptr: any, slice_len: any, slice_cap: any) => {
                ...
                "syscall/js.copyBytesToGo": (ret_addr: any, dest_addr: any, dest_len: any, dest_cap: any, src_ref: any) => {
                ...
                "syscall/js.copyBytesToJS": (ret_addr: any, dst_ref: any, src_addr: any, src_len: any, src_cap: any) => {
                    let num_bytes_copied_addr = ret_addr;
                    let returned_status_addr = ret_addr + 4; // Address of returned boolean status variable
